...
public class SqoopOptions implements Cloneable {
  ...
  private String password;
    ...
    //Anthonyc add date
    @StoredAsProperty("job.lastuse") private String jobLastuse;
  ...
  public void setConnectString(String connectStr) {
    ...
    public String getJobLastuse(){
	return jobLastuse;
    }

    public void setJobLastuse( String date ){
	this.jobLastuse = date;
    }
